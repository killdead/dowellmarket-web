...
function westorElggMan_init()
{
	...
	elgg_register_page_handler("westorElggMan", "westorElggMan_page_handler");
}
...
function westorElggMan_pagesetup(){
	if(elgg_in_context("admin") && elgg_is_admin_logged_in()){

			
		elgg_register_admin_menu_item('administer', 'user_administer', 'users');
		
	}
}
//http://localhost/elgg/mod/westorElggMan/build/index.php

westorElggMan_register_elgg_event_handler('init', 'system', 'westorElggMan_init');
elgg_register_event_handler('pagesetup', 'system', 'westorElggMan_pagesetup');
