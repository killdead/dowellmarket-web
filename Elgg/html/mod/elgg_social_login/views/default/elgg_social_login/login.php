<?php
	...
	<p style="border-top:1px dotted #999;font-size: 10px;">
		...
		<?php
			if( elgg_get_plugin_setting( 'ha_settings_privacy_page', 'elgg_social_login' ) ){
		?> 
			| <a href="<?php echo elgg_get_plugin_setting( 'ha_settings_privacy_page', 'elgg_social_login' ) ?>" target="_blank">Privacy</a>
		<?php
			}
		?> 
	</p>
